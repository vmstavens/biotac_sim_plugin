...
// makeTransform(double px, double py, double pz, double rx, double ry, double rz, double rw) {
...
inline std::vector<std::string> fingerLinkNames = {
...
inline std::vector<Eigen::Affine3d> fingerToSensorTransforms = {
...
inline std::vector<Eigen::Vector3d> electrodePositions = []() 
{
...
// // (extracted from urdf model using tf)
// inline std::vector<Eigen::Affine3d> fingerToSensorTransforms = {
// 	makeTransform(-0.000, -0.007, 0.051, -0.405, -0.405, -0.580, 0.580), 
// 	makeTransform(-0.000, -0.007, 0.051, -0.405, -0.405, -0.580, 0.580), 
// 	makeTransform(-0.000, -0.007, 0.051, -0.405, -0.405, -0.580, 0.580), 
// 	makeTransform(-0.000, -0.007, 0.051, -0.405, -0.405, -0.580, 0.580), 
// 	makeTransform(-0.007, 0.000, 0.054, 0.573, 0.000, 0.820, -0.000),
// };
